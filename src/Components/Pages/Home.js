...
const Home = () => {
    return (
        <div className='grid lg:grid-cols-2 grid-cols-1 lg:gap-10 gap-6 items-center h-[86vh]'>
            <div className='lg:-order-none order-6'>
                ...
                <button className='bg-green-700 px-6 py-2 text-white rounded mt-4 font-bold'>Live Demo</button>
            </div>
            <div>
